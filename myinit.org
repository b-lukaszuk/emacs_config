...
#+BEGIN_SRC emacs-lisp
  ...
  ;; shell> mkdir NewSysImageEnv
  ;; shell> cd NewSysImageEnv
  ...
  ;; replace ~/etc. in the path with /home/user-name/etc.
  (setq lsp-julia-flags `("-J/home/oisezc/julia-1.8.3/myBLcompiled/languageserver.so"))
