...
#+END_SRC
* pdf-tools (lepsze przegladanie pdf-ow)
...
za: https://emacs.cafe/emacs/javascript/setup/2017/04/23/emacs-setup-javascript.html
...
Za: https://misshula.org/articles/debugging-javascript.html

uruchamianie:
1. ~M-x run-skewer~ 
   odpala przegladarke http://127.0.0.1:8080/skewer/demo
2. ~M-x skewer-repl~ (odpala repl-a w Emacsie)
...
(use-package ac-js2
  ...
  ;; przy uzywaniu bibliotek js-owych dodac to co ponizej
